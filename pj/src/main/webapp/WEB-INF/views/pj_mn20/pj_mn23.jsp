...
<html lang="ko">
  ...
  <body>
    ...
    <form action="register2.html" method="get" enctype=""><div class="entry">
        <p>
            <textarea cols="40" rows="25">개인정보 수집 및 이용동의
                1. 개인정보의 수집 및 이용 목적
        ...
        <p>
            <textarea cols="40" rows="25"> 민감정보의 수집 및 이용동의
                1. 개인정보의 수집 및 이용 목적
                - 입사전형 진행, 입사지원서 수정, 자격요건의 확인, 합격여부 확인, 지원자와의 원활한 의사소통 경로 확보
    ...
    <div>
        ...
        <input type="submit" value="동의하지 않습니다.">
    </div>
    </form>
</div>
