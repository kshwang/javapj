...
<style type="text/css">
        ...
        .sthead {  border-top: solid, 1px, black;   }
        .select{float: right;}
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="text" size="20"
                                    name="name" style="width: 304px; "></td>
                            ...
                            <tr>
                                <th>이력서 파일첨부</th>
                                <td>
                                <input type="file"  name = "file1"size="20" name="name" style="width: 80%; ">
                                  <input type="file"  name = "file2"size="20" name="name" style="width:80%;margin-top:3px; ">
                                  <input type="file"  name = "file3"size="20" name="name" style="width:80%;margin-top:3px; ">
                                  <input type="file"  name = "file4"size="20" name="name" style="width:80%;margin-top:3px; ">
                                  <input type="file"  name = "file5"size="20" name="name" style="width:80%;margin-top:3px; ">
                                    <ul>
                                        <li>이력서는 자유롭게 작성하셔서 등록해 주시기 바랍니다.</li>
                                        <li>저희는 지원자의 고유식별정보를 수집하지 않으므로 이력서에 주민등록번호 등을 기록하지 않도록 유의하여 주시기 바랍니다.</li>
                                        <li>파일 최대용량은 20MB입니다.</li>
                                        <li>파일은 최대 5개까지 첨부 가능합니다.</li>
                                        <li>hwp, doc, xls, ppt, docx, xlsx, pptx, pdf 형식의 파일만 첨부 가능합니다.
                                        </li>
                                    </ul>
                                 </td>
                            </tr>
